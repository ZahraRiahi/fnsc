...
public interface UserPermissionRepository extends JpaRepository<UserPermission, Long> {
    ...
    @Query("  select count(up.id) " +
            ...
            "     and ( :financialUserIdCreator is null or up.financialUserIdCreator =  :financialUserIdCreator )" +
            "     and up.financialTypeActivityId =  :financialActivityTypeId " +
            "     and (:financialDocumentTypeId is null or up.financialDocumentTypeId =  :financialDocumentTypeId) " +
            "     and (:financialPeriodId is null or up.financialPeriodId =  :financialPeriodId) " +
